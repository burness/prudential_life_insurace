...
clf = NN(inputShape = train.shape[1], layers = [512,256,128, 64], dropout = [0.5, 0.5], loss='mae', optimizer = 'adadelta', init = 'glorot_normal', nb_epochs = 20)
...
submission.to_csv('../data/NNSubmission.csv', index=False)